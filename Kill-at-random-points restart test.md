...
- 2026-09-01 **green** (exit 0) `npx vitest run test/loop/kill-restart-idempotence.test.ts` — Duration  34.93s (transform 469ms, setup 0ms, collect 693ms, tests 33.10s, environment 0ms, prepare 185ms) [spec ce11f01e61fd]
