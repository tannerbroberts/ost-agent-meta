...
**Contrast with siblings:** class-level ranking operates on many nodes in one act; misconception-weaving governs how a *wrong* node stays visible after correction. This one is the atom both compose from — single-node motion with memory.

**Provenance caveat:** founder-directed (2026-08-10), floor rung (`assertion`). Revises hygiene doctrine P5's "annotate, never delete" by splitting it: never *lose* stays, never *move* goes.
