...
This is the segment whose failure mode the tool is shaped around. The gates, the ladder, the refusal to self-validate are all substitutes for the colleague they do not have.

**Compared to the alternatives.** The most defensible from what is actually known, since it describes the operator this vault has been serving for weeks and the friction record is real evidence about that person's experience. It is also the smallest and poorest segment, notoriously hard to reach and hard to charge, and it may want a cheap tool rather than a rigorous one.
