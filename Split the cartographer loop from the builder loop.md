...
[[A builder can work from the map without ideating on it]]
...
**How it differs from its siblings:** structural separation — the two jobs cannot compete for attention because they do not share a scheduler. The siblings keep one actor and constrain its behaviour instead.

**Trade-off:** two loops need a contract between them; a builder that disagrees with the map either goes off-plan or stalls, and the handoff can become the new bottleneck.
...
- 2026-08-05 unlinked "Can a builder work from the map without ideating" — moved under "A builder can work from the map without ideating on it" — the belief this test measures now has a node of its own
