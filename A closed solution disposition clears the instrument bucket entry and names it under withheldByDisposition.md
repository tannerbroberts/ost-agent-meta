...
- 2026-08-30 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-08-30 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-08-31 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-08-31 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-08-31 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-08-31 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-08-31 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
...
- 2026-08-31 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-08-31 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-01 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-01 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-01 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-01 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-01 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
...
- 2026-09-01 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-01 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-02 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-02 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-02 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-02 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-02 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
...
- 2026-09-02 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-02 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-03 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
- 2026-09-03 **no-spec** (exit none) `npx vitest run test/evidence/dispose-solution-instrument-bucket.test.ts` — test/evidence/dispose-solution-instrument-bucket.test.ts does not exist — no spec was collected, so nothing was measured
...
## 2026-08-30 (later firing) — the same census, sampled adversarially instead of off the head

The section above counts 6 of 6 and states its own limit honestly: the six were read off the unfiltered head of the bucket, so the sample is neither random nor a census, and it "bounds nothing about the 41 unseen entries." This firing extended it by four entries chosen on the opposite principle, and the result is worth one paragraph because the method is what is new, not the number.

**What was sampled and why.** Rather than reading further down the head, this pass picked the four entries it judged **most likely to be genuinely instrumentable** — the ones that would falsify the abstention hypothesis if anything would: "Remote push optional and off by default" (a config default, trivially assertable), "Axioms elicited at the moment a derivation needs them, one accept-or-reject ask at a time" and "Borrow the axiom set from a named body of practice and let the human only veto" (the proof-rung machinery is in this repository), and "A background task's own output directory is automatically readable by the Monitor call that started it". Adding "Group the queue by error signature at read time, and change nothing on disk" and "Append-only tool surface with no delete or shell tool", read earlier in the same pass, the running total is **10 of 10 ineligible**, each for a reason the node states about itself.

**The four add three distinct abstention reasons, not more of the same one.** "Remote push optional and off by default" is the sharpest: the mechanism ships and is pinned by two green specs, so an instrument there would pass on arrival — a case where instrumenting is not merely unnecessary but forbidden by the red-before-green rule. The two axiom candidates rest on desirability and viability judgements about one person's behaviour over time. The Monitor candidate's artefact is a harness tool no spec under this repository's `test/` can reach. So the bucket's ineligibility is over-determined: it is not one systematic misclassification with a single fix, but at least four independent reasons a solution can correctly have no instrument.

**Why an adversarial sample matters more here than a larger one.** A hypothesis confirmed by entries picked because they were convenient is weak evidence; the same hypothesis surviving entries picked because they were the likeliest counterexamples is stronger, and it is cheaper than reading all 68. Zero of the four best candidates for falsification turned out to be instrumentable. That does not make it a census — 10 of 68 is still a sample, still not random, and the 58 unread entries remain unbounded — but it does move the estimate from "common at the head" to "common among the entries most likely to be exceptions."
