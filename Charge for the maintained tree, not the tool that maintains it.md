...
This aligns the price with the thing that is hard. Generating a tree once is nearly free now; keeping one honest as evidence accumulates is the work, and it is the work that stops happening when a person gets busy.

**Compared to the alternatives.** Recurring, understandable, and it scales with the customer's own product portfolio rather than with usage they cannot predict. It is also the hardest to deliver, since the vendor is on the hook for maintenance quality every month, and the customer will judge it by whether the tree looks tended rather than by anything measurable.
