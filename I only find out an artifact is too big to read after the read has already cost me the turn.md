...
[[An over-cap read returns the head and the offset that fetches the rest, instead of refusing]]
[[Adopt the harness's own offset and limit protocol across every reader here, and build only the adapter]]
