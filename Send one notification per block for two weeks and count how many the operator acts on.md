...
- 2026-08-12 **green** (exit 0) `npx vitest run test/loop/block-notification.test.ts` — Duration  424ms (transform 147ms, setup 0ms, collect 221ms, tests 11ms, environment 0ms, prepare 24ms)
