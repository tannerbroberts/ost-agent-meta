...
**Related and unchecked:** "Refuse a proving command whose exit code cannot report failure" and "Refuse a write whose content is empty or literally undefined" are siblings of the same era and may have shipped too.
