...
The ladder, the provenance, and the append-only history are all directly legible as answers to "how do you know that", which is the question this person is actually being asked.

**Compared to the alternatives.** Much better funded than the solo builder and much easier to charge, with a budget line that already exists for research tools. It is also a crowded market where funded competitors are already selling, and it needs the artefact to be presentable to people who will never open Obsidian — which is a real product gap, not a positioning one.
