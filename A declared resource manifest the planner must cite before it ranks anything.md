...
[[Declaring the operator's real resources changes which work comes first]]
...
## History
- 2026-08-05 unlinked "Hand-fill the manifest and count how many of the top five priorities move" — moved under "Declaring the operator's real resources changes which work comes first" — the belief this test measures now has a node of its own
